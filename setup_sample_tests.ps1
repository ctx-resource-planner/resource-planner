...
"@ | Out-File -FilePath "$testDir\test_employee.py" -Encoding utf8

Write-Host "✅ Sample tests created!" -ForegroundColor Green
Write-Host "Run the next script: .\setup_cleanup.ps1"