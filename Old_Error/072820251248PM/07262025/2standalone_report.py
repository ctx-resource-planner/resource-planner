    ...
    <div class="control-panel">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-end">
                ##<input type="text" id="globalSearch" class="form-control d-inline-block me-2" style="width: 200px;" placeholder="🔍 Search employees..." />
...
$(document).ready(function() {
    ...
    "paging": false,
    "info": false,
    "searching": true,  // CHANGED: Re-enable DataTables search - this was working!
    "ordering": true,
    "scrollX": true,
    "order": [[ 0, "asc" ]],
    "fixedColumns": {
