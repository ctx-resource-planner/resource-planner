...
def generate_project_setup_pdf(project_setup, form_data):
    """Generate PDF that looks like the preview page"""
    try:
        import pdfkit
        from flask import render_template_string
        
        # Create HTML content that matches your preview
        html_content = render_template('utilities/project_setup_preview.html', data=form_data)
        
        # Configure PDF options for better screenshot-like output
        options = {
            'page-size': 'A4',
            'margin-top': '0.75in',
            'margin-right': '0.75in',
